...
// Sat Oct 24 21:24:29 2015 by ROOT version 6.02/10
...
public :
   ...
   Int_t           nVtxSim;
   Float_t         xVtxSim[4];   //[nVtxSim]
   Float_t         yVtxSim[4];   //[nVtxSim]
   Float_t         zVtxSim[4];   //[nVtxSim]
   ...
   Int_t           nTrkTimesnVtx;
   Bool_t          trkAssocVtx[maxTracks];   //[nTrkTimesnVtx]
   Bool_t          highPurity[maxTracks];   //[nTrk]
   Bool_t          tight[maxTracks];   //[nTrk]
   Bool_t          loose[maxTracks];   //[nTrk]
   ...
   Int_t           trkAlgo[maxTracks];   //[nTrk]
   Int_t           trkOriginalAlgo[maxTracks];   //[nTrk]
   Float_t         trkMVA[maxTracks];   //[nTrk]
   Int_t           pfType[maxTracks];   //[nTrk]
   Float_t         pfCandPt[maxTracks];   //[nTrk]
   Float_t         pfEcal[maxTracks];   //[nTrk]
   Float_t         pfHcal[maxTracks];   //[nTrk]
...
void setupTrackTree(TTree *t,Tracks &tTracks,bool doCheck = 1)
{
   ...
   if (doCheck) {
      ...
      if (t->GetMaximum("nTrkTimesnVtx")>maxTracks) cout <<"FATAL ERROR: Arrary size of nTrkTimesnVtx too small!!!  "<<t->GetMaximum("nTrkTimesnVtx")<<endl;
   }
}
